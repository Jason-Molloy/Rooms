...
namespace Rooms.Project
{
  public class GameService : IGameService
  {
    ...
    public void Setup()
    {
      ...
      Item cookie = new Item("A Cookie", "An array of homemade sugar cookies - decorated by a child's hands.");
      Item sandwich = new Item("A Sandwich", "A very tasty looking sandwich - this thing would make Dagwood blush. A high stack of meats, cheeses, sandwich fixins and other unidentifiable forms of deliciousness.");
